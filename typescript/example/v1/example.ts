...
// ExampleDatasetService is the API used to configure example objects.
export interface IExampleDatasetService {
  ...
  ListExampleDatasets: (req: arangodb_cloud_common_v1_ListOptions) => Promise<ExampleDatasetList>;
  ...
  CreateExampleDataset: (req: ExampleDataset) => Promise<ExampleDataset>;
  
  // Update an example dataset.
  // Required permissions:
  // -  example.exampledataset.update on the example identified by the given ID.
  UpdateExampleDataset: (req: ExampleDataset) => Promise<ExampleDataset>;
  ...
  DeleteExampleDataset: (req: arangodb_cloud_common_v1_IDOptions) => Promise<void>;
...
export class ExampleDatasetService implements IExampleDatasetService {
  ...
  // Required permissions:
  // - example.exampledataset.list
  async ListExampleDatasets(req: arangodb_cloud_common_v1_ListOptions): Promise<ExampleDatasetList> {
  ...
  // Required permissions:
  // -  example.exampledataset.create
  async CreateExampleDataset(req: ExampleDataset): Promise<ExampleDataset> {
    const url = `/api/example/v1/exampledataset`;
  ...
  // Required permissions:
  // -  example.exampledataset.update on the example identified by the given ID.
  async UpdateExampleDataset(req: ExampleDataset): Promise<ExampleDataset> {
    const url = `/api/example/v1/exampledataset/${encodeURIComponent(req.id || '')}`;
  ...
  // Required permissions:
  // -  example.exampledataset.delete on the example identified by the given ID.
  async DeleteExampleDataset(req: arangodb_cloud_common_v1_IDOptions): Promise<void> {
    const path = `/api/example/v1/exampledataset/${encodeURIComponent(req.id || '')}`;
    const url = path + api.queryString(req, [`id`]);
