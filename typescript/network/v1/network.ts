...
export interface PrivateEndpointService {
  ...
  // PrivateEndpointService_Gcp
  gcp?: PrivateEndpointService_Gcp;
...
// Specific GCP setting.
export interface PrivateEndpointService_Gcp {
...
export interface PrivateEndpointService_GcpPrivateEndpointConnectionStatus {
  // The name of the private endpoint connection
  // string
  name?: string;
...
// All fields are read-only.
export interface PrivateEndpointService_GcpStatus {
  ...
  // The status of the private endpoint connections.
  // PrivateEndpointService_GcpPrivateEndpointConnectionStatus
  private_endpoint_connections?: PrivateEndpointService_GcpPrivateEndpointConnectionStatus[];
}
...
export interface PrivateEndpointService_Status {
  ...
  // Specific GCP status fields.
  // All fields are read-only.
  // PrivateEndpointService_GcpStatus
  gcp?: PrivateEndpointService_GcpStatus;
}
