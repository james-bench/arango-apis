...
type UsageItem_Resource struct {
	...
	PrepaidDeploymentStartsAt string `protobuf:"bytes,17,opt,name=prepaid_deployment_starts_at,json=prepaidDeploymentStartsAt,proto3" json:"prepaid_deployment_starts_at,omitempty"`
	// Timestamp when the prepaid_deployment ends
	PrepaidDeploymentEndsAt string   `protobuf:"bytes,18,opt,name=prepaid_deployment_ends_at,json=prepaidDeploymentEndsAt,proto3" json:"prepaid_deployment_ends_at,omitempty"`
	XXX_NoUnkeyedLiteral    struct{} `json:"-"`
	XXX_unrecognized        []byte   `json:"-"`
	XXX_sizecache           int32    `json:"-"`
}
...
func (m *UsageItem_Resource) GetPrepaidDeploymentStartsAt() string {
	if m != nil {
...
func (m *UsageItem_Resource) GetPrepaidDeploymentEndsAt() string {
	if m != nil {
...
var fileDescriptor_fc9154f4fefb0f53 = []byte{
	...
	,
}
...
func (m *UsageItem_Resource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PrepaidDeploymentEndsAt) > 0 {
		i -= len(m.PrepaidDeploymentEndsAt)
		copy(dAtA[i:], m.PrepaidDeploymentEndsAt)
		i = encodeVarintUsage(dAtA, i, uint64(len(m.PrepaidDeploymentEndsAt)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x92
	}
	if len(m.PrepaidDeploymentStartsAt) > 0 {
		i -= len(m.PrepaidDeploymentStartsAt)
		copy(dAtA[i:], m.PrepaidDeploymentStartsAt)
		i = encodeVarintUsage(dAtA, i, uint64(len(m.PrepaidDeploymentStartsAt)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x8a
...
func (m *UsageItem_Resource) Size() (n int) {
	...
	l = len(m.PrepaidDeploymentStartsAt)
	if l > 0 {
		n += 2 + l + sovUsage(uint64(l))
	}
	l = len(m.PrepaidDeploymentEndsAt)
	if l > 0 {
		n += 2 + l + sovUsage(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *UsageItem_Resource) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			...
			m.PrepaidDeploymentStartsAt = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 18:
			if wireType != 2 {
			...
			m.PrepaidDeploymentEndsAt = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipUsage(dAtA[iNdEx:])
