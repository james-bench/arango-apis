...
type UsageItem_AuditLogSize struct {
	...
	CloudEventCount int64 `protobuf:"varint,1,opt,name=cloud_event_count,json=cloudEventCount,proto3" json:"cloud_event_count,omitempty"`
	// Amount of cloud storage (in bytes) used by audit log.
	CloudStorageSize int64 `protobuf:"varint,2,opt,name=cloud_storage_size,json=cloudStorageSize,proto3" json:"cloud_storage_size,omitempty"`
	// Number of https post invocations used by audit log.
	HttpsPostCount int64 `protobuf:"varint,11,opt,name=https_post_count,json=httpsPostCount,proto3" json:"https_post_count,omitempty"`
	// Amount of https post body (in bytes) used by audit log.
	HttpsPostBodySize    int64    `protobuf:"varint,12,opt,name=https_post_body_size,json=httpsPostBodySize,proto3" json:"https_post_body_size,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *UsageItem_AuditLogSize) GetCloudEventCount() int64 {
	if m != nil {
		return m.CloudEventCount
	}
	return 0
}

func (m *UsageItem_AuditLogSize) GetCloudStorageSize() int64 {
	if m != nil {
		return m.CloudStorageSize
	}
	return 0
...
func (m *UsageItem_AuditLogSize) GetHttpsPostBodySize() int64 {
	if m != nil {
		return m.HttpsPostBodySize
	}
	return 0
}
...
var fileDescriptor_fc9154f4fefb0f53 = []byte{
	...
	,
}
...
func (m *UsageItem_AuditLogSize) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HttpsPostBodySize != 0 {
		i = encodeVarintUsage(dAtA, i, uint64(m.HttpsPostBodySize))
		i--
		dAtA[i] = 0x60
	}
	...
	if m.CloudEventCount != 0 {
		i = encodeVarintUsage(dAtA, i, uint64(m.CloudEventCount))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *UsageItem_AuditLogSize) Size() (n int) {
	...
	_ = l
	if m.CloudEventCount != 0 {
		n += 1 + sovUsage(uint64(m.CloudEventCount))
	}
	if m.CloudStorageSize != 0 {
		n += 1 + sovUsage(uint64(m.CloudStorageSize))
	}
	if m.HttpsPostCount != 0 {
		n += 1 + sovUsage(uint64(m.HttpsPostCount))
	}
	if m.HttpsPostBodySize != 0 {
		n += 1 + sovUsage(uint64(m.HttpsPostBodySize))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *UsageItem_AuditLogSize) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CloudEventCount", wireType)
			}
			m.CloudEventCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CloudEventCount |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpsPostBodySize", wireType)
			}
			m.HttpsPostBodySize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowUsage
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HttpsPostBodySize |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
