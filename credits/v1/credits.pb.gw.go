...
var (
	...
	pattern_CreditsService_GetUsagePDFReport_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 2, 5}, []string{"api", "credit", "v1", "organization_id", "creditbundleusages", "pdf"}, "", runtime.AssumeColonVerbOpt(true)))
)
