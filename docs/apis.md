...
| total_amount_excl_vat | [float](#float) |  | Sum all amount for all items (excluding VAT and sales tax) |
...
| total_amount_incl_vat | [float](#float) |  | Sum of total_amount_ex_vat &#43; total_vat &#43; total_sales_tax. This is the amount that the customer will be charged for. |
