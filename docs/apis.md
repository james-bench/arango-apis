...
- [data/v1/data.proto](#data/v1/data.proto)
    ...
    - [DeploymentFeatures](#arangodb.cloud.data.v1.DeploymentFeatures)
    - [DeploymentFeaturesRequest](#arangodb.cloud.data.v1.DeploymentFeaturesRequest)
...
| region_id | [string](#string) |  | ID of region in which the deployment will be created. |
...
| ----- | ---- | ----- | ----------- |
| model | [string](#string) |  | Type of model being used |
| node_size_id | [string](#string) |  | Size of nodes being used This field is ignored set in case the flexible model is used. |
| node_count | [int32](#int32) |  | Number of nodes being used This field is ignored set in case the flexible model is used. |
| node_disk_size | [int32](#int32) |  | Amount of disk space per node (in GB) This field is ignored set in case the flexible model is used. |
...
| last_started_at | [google.protobuf.Timestamp](#google.protobuf.Timestamp) |  | The last started timestamp of the server |
...
<a name="arangodb.cloud.data.v1.DeploymentFeatures"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| iamprovider | [bool](#bool) |  | Is the use of an IAM provider available? |
...
<a name="arangodb.cloud.data.v1.DeploymentFeaturesRequest"></a>
...
| model | [string](#string) |  | Model of the intended deployment. |
| node_size_id | [string](#string) |  | Node size use for the intended deployments |
...
| disk_sizes | [int32](#int32) | repeated | If set, contains list of possible disk sizes (in GB) for the node. In that case, this field overrides the min_disk_size &amp; max_disk_size fields. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| destination | [string](#string) |  | The destination (or source) the network traffic going to (or comming from) Can be &#39;Internet&#39; or &#39;SameRegion&#39; An empty string means &#39;Internet&#39; |
| total_transfer_ingress_size | [int64](#int64) |  | Total amount of network ingress traffic (in bytes) caused by the use of a deployment. Destination &#39;Internet&#39;: This is traffic comming from the internet, so excluding inner cluster traffic Destination &#39;SameRegion&#39;: This is inner cluster traffic only This is always excluding backup traffic (downloads). |
| total_transfer_egress_size | [int64](#int64) |  | Total amount of network egress traffic (in bytes) caused by the use of a deployment. Destination &#39;Internet&#39;: This is traffic going to the internet, so excluding inner cluster traffic Destination &#39;SameRegion&#39;: This is inner cluster traffic only This is always excluding backup traffic (uploads).
