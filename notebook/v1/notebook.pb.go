...
type Status struct {
	...
	LastActiveAt *types.Timestamp `protobuf:"bytes,5,opt,name=last_active_at,json=lastActiveAt,proto3" json:"last_active_at,omitempty"`
	// Endpoint URL used to reach the notebook on default port 443
	// This value will be empty during the creation of the notebook.
	EndpointDefault string `protobuf:"bytes,6,opt,name=endpoint_default,json=endpointDefault,proto3" json:"endpoint_default,omitempty"`
...
var fileDescriptor_e4288154b4c2ba34 = []byte{
	...
	,
}
