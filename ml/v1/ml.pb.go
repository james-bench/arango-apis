...
type Status struct {
	...
	FirstEnabledAt *types.Timestamp `protobuf:"bytes,8,opt,name=first_enabled_at,json=firstEnabledAt,proto3" json:"first_enabled_at,omitempty"`
	// Timestamp of when MLServices were last enabled for this deployment.
	LastEnabledAt        *types.Timestamp `protobuf:"bytes,9,opt,name=last_enabled_at,json=lastEnabledAt,proto3" json:"last_enabled_at,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *Status) GetFirstEnabledAt() *types.Timestamp {
	if m != nil {
		return m.FirstEnabledAt
	}
	return nil
}
...
var fileDescriptor_378f7d136b22f2a8 = []byte{
	...
	,
}
...
func (m *Status) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.FirstEnabledAt != nil {
		{
			size, err := m.FirstEnabledAt.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Status) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FirstEnabledAt", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.FirstEnabledAt == nil {
				m.FirstEnabledAt = &types.Timestamp{}
			}
			if err := m.FirstEnabledAt.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
