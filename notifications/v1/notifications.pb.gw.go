...
var (
	pattern_NotificationsService_GetAPIVersion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "notifications", "v1", "api-version"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_NotificationsService_ListDeploymentNotifications_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "notifications", "v1", "deployment_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
