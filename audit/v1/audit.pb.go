...
type AuditLog_DestinationStatus struct {
	...
	// on the day as specified by updated_at.
	BytesSinceMidnight int64 `protobuf:"varint,11,opt,name=bytes_since_midnight,json=bytesSinceMidnight,proto3" json:"bytes_since_midnight,omitempty"`
	...
	HttpsPostSucceededCountSinceMidnight int64 `protobuf:"varint,20,opt,name=https_post_succeeded_count_since_midnight,json=httpsPostSucceededCountSinceMidnight,proto3" json:"https_post_succeeded_count_since_midnight,omitempty"`
	// The number of bytes of successfull HTTPS post this destination (for the provided deployment) has been sent
	// on the day as specified by updated_at.
	// This field is used when the destination type is "https-post" only
	HttpsPostSucceededBytesSinceMidnight int64 `protobuf:"varint,21,opt,name=https_post_succeeded_bytes_since_midnight,json=httpsPostSucceededBytesSinceMidnight,proto3" json:"https_post_succeeded_bytes_since_midnight,omitempty"`
	// The number of unsuccessfull HTTPS posts this destination (for the provided deployment) has been trying to sent
	// on the day as specified by updated_at.
	// This field is used when the destination type is "https-post" only
	HttpsPostFailedCountSinceMidnight int64 `protobuf:"varint,22,opt,name=https_post_failed_count_since_midnight,json=httpsPostFailedCountSinceMidnight,proto3" json:"https_post_failed_count_since_midnight,omitempty"`
	// The number of bytes of unsuccessfull HTTPS post this destination (for the provided deployment) has been trying to sent
	// on the day as specified by updated_at.
	// This field is used when the destination type is "https-post" only
	HttpsPostFailedBytesSinceMidnight int64    `protobuf:"varint,23,opt,name=https_post_failed_bytes_since_midnight,json=httpsPostFailedBytesSinceMidnight,proto3" json:"https_post_failed_bytes_since_midnight,omitempty"`
	XXX_NoUnkeyedLiteral              struct{} `json:"-"`
	XXX_unrecognized                  []byte   `json:"-"`
	XXX_sizecache                     int32    `json:"-"`
}
...
func (m *AuditLog_DestinationStatus) GetBytesSinceMidnight() int64 {
	if m != nil {
		return m.BytesSinceMidnight
	}
	return 0
}

func (m *AuditLog_DestinationStatus) GetHttpsPostSucceededCountSinceMidnight() int64 {
	if m != nil {
		return m.HttpsPostSucceededCountSinceMidnight
	}
	return 0
}

func (m *AuditLog_DestinationStatus) GetHttpsPostSucceededBytesSinceMidnight() int64 {
	if m != nil {
		return m.HttpsPostSucceededBytesSinceMidnight
	}
	return 0
}

func (m *AuditLog_DestinationStatus) GetHttpsPostFailedCountSinceMidnight() int64 {
	if m != nil {
		return m.HttpsPostFailedCountSinceMidnight
	}
	return 0
}

func (m *AuditLog_DestinationStatus) GetHttpsPostFailedBytesSinceMidnight() int64 {
	if m != nil {
		return m.HttpsPostFailedBytesSinceMidnight
	}
	return 0
}
...
var fileDescriptor_5594839dd8e38a1b = []byte{
	...
	,
}
...
func (m *AuditLog_DestinationStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HttpsPostFailedBytesSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.HttpsPostFailedBytesSinceMidnight))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb8
	}
	if m.HttpsPostFailedCountSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.HttpsPostFailedCountSinceMidnight))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb0
	}
	if m.HttpsPostSucceededBytesSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.HttpsPostSucceededBytesSinceMidnight))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa8
	}
	if m.HttpsPostSucceededCountSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.HttpsPostSucceededCountSinceMidnight))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
	}
	if m.BytesSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.BytesSinceMidnight))
		i--
		dAtA[i] = 0x58
	}
...
func (m *AuditLog_DestinationStatus) Size() (n int) {
	...
	if m.BytesSinceMidnight != 0 {
		n += 1 + sovAudit(uint64(m.BytesSinceMidnight))
	}
	if m.HttpsPostSucceededCountSinceMidnight != 0 {
		n += 2 + sovAudit(uint64(m.HttpsPostSucceededCountSinceMidnight))
	}
	if m.HttpsPostSucceededBytesSinceMidnight != 0 {
		n += 2 + sovAudit(uint64(m.HttpsPostSucceededBytesSinceMidnight))
	}
	if m.HttpsPostFailedCountSinceMidnight != 0 {
		n += 2 + sovAudit(uint64(m.HttpsPostFailedCountSinceMidnight))
	}
	if m.HttpsPostFailedBytesSinceMidnight != 0 {
		n += 2 + sovAudit(uint64(m.HttpsPostFailedBytesSinceMidnight))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *AuditLog_DestinationStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BytesSinceMidnight", wireType)
			}
			m.BytesSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BytesSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpsPostSucceededCountSinceMidnight", wireType)
			}
			m.HttpsPostSucceededCountSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HttpsPostSucceededCountSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpsPostSucceededBytesSinceMidnight", wireType)
			}
			m.HttpsPostSucceededBytesSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HttpsPostSucceededBytesSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 22:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpsPostFailedCountSinceMidnight", wireType)
			}
			m.HttpsPostFailedCountSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HttpsPostFailedCountSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 23:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpsPostFailedBytesSinceMidnight", wireType)
			}
			m.HttpsPostFailedBytesSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HttpsPostFailedBytesSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
