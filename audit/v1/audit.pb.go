...
type AuditLog_DestinationStatus struct {
	...
	EventsSucceededSinceMidnight int64 `protobuf:"varint,10,opt,name=events_succeeded_since_midnight,json=eventsSucceededSinceMidnight,proto3" json:"events_succeeded_since_midnight,omitempty"`
	// The number of unsuccessfull audit log events this destination (for the provided deployment) has been trying to process
	// on the day as specified by updated_at.
	EventsFailedSinceMidnight int64 `protobuf:"varint,11,opt,name=events_failed_since_midnight,json=eventsFailedSinceMidnight,proto3" json:"events_failed_since_midnight,omitempty"`
...
func (m *AuditLog_DestinationStatus) GetEventsSucceededSinceMidnight() int64 {
	if m != nil {
		return m.EventsSucceededSinceMidnight
	}
	return 0
}

func (m *AuditLog_DestinationStatus) GetEventsFailedSinceMidnight() int64 {
	if m != nil {
		return m.EventsFailedSinceMidnight
	}
	return 0
}
...
var fileDescriptor_5594839dd8e38a1b = []byte{
	...
	,
}
...
func (m *AuditLog_DestinationStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EventsFailedSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.EventsFailedSinceMidnight))
		i--
		dAtA[i] = 0x58
	}
	if m.EventsSucceededSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.EventsSucceededSinceMidnight))
		i--
		dAtA[i] = 0x50
	}
	if m.UpdatedAt != nil {
...
func (m *AuditLog_DestinationStatus) Size() (n int) {
	...
	if m.EventsSucceededSinceMidnight != 0 {
		n += 1 + sovAudit(uint64(m.EventsSucceededSinceMidnight))
	}
	if m.EventsFailedSinceMidnight != 0 {
		n += 1 + sovAudit(uint64(m.EventsFailedSinceMidnight))
	}
	if m.BytesSucceededSinceMidnight != 0 {
...
func (m *AuditLog_DestinationStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EventsSucceededSinceMidnight", wireType)
			}
			m.EventsSucceededSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EventsSucceededSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EventsFailedSinceMidnight", wireType)
			}
			m.EventsFailedSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EventsFailedSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
