...
type AuditLog_HttpsPostSettings struct {
	...
	RetryPeriodDeletedDeployment *types.Duration `protobuf:"bytes,200,opt,name=retry_period_deleted_deployment,json=retryPeriodDeletedDeployment,proto3" json:"retry_period_deleted_deployment,omitempty"`
	XXX_NoUnkeyedLiteral         struct{}        `json:"-"`
	XXX_unrecognized             []byte          `json:"-"`
	XXX_sizecache                int32           `json:"-"`
}
...
func (m *AuditLog_HttpsPostSettings) GetRetryPeriodDeletedDeployment() *types.Duration {
	if m != nil {
		return m.RetryPeriodDeletedDeployment
	}
	return nil
}
...
var fileDescriptor_5594839dd8e38a1b = []byte{
	...
	,
}
...
func (m *AuditLog_HttpsPostSettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RetryPeriodDeletedDeployment != nil {
		{
			size, err := m.RetryPeriodDeletedDeployment.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AuditLog_HttpsPostSettings) Size() (n int) {
	...
	if m.RetryPeriodDeletedDeployment != nil {
		l = m.RetryPeriodDeletedDeployment.Size()
		n += 2 + l + sovAudit(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *AuditLog_HttpsPostSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 200:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RetryPeriodDeletedDeployment", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RetryPeriodDeletedDeployment == nil {
				m.RetryPeriodDeletedDeployment = &types.Duration{}
			}
			if err := m.RetryPeriodDeletedDeployment.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
