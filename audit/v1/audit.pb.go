...
type AuditLog_DestinationStatus struct {
	...
	EventsSinceMidnight int64 `protobuf:"varint,10,opt,name=events_since_midnight,json=eventsSinceMidnight,proto3" json:"events_since_midnight,omitempty"`
	...
	EventsExcludedSinceMidnight int64 `protobuf:"varint,11,opt,name=events_excluded_since_midnight,json=eventsExcludedSinceMidnight,proto3" json:"events_excluded_since_midnight,omitempty"`
	...
	EventsUndeliverableSinceMidnight int64 `protobuf:"varint,12,opt,name=events_undeliverable_since_midnight,json=eventsUndeliverableSinceMidnight,proto3" json:"events_undeliverable_since_midnight,omitempty"`
	// The bytes of successfull audit log events this destination (for the provided deployment) has been processed
	// on the day as specified by updated_at.
	BytesSucceededSinceMidnight int64 `protobuf:"varint,20,opt,name=bytes_succeeded_since_midnight,json=bytesSucceededSinceMidnight,proto3" json:"bytes_succeeded_since_midnight,omitempty"`
	...
	BytesFailedSinceMidnight int64 `protobuf:"varint,21,opt,name=bytes_failed_since_midnight,json=bytesFailedSinceMidnight,proto3" json:"bytes_failed_since_midnight,omitempty"`
	...
	HttpsPostsSucceededSinceMidnight int64 `protobuf:"varint,30,opt,name=https_posts_succeeded_since_midnight,json=httpsPostsSucceededSinceMidnight,proto3" json:"https_posts_succeeded_since_midnight,omitempty"`
	// The number of unsuccessfull HTTPS posts this destination (for the provided deployment) has been trying to sent
	// on the day as specified by updated_at.
	// This field is used when the destination type is "https-post" only.
	HttpsPostsFailedSinceMidnight int64 `protobuf:"varint,31,opt,name=https_posts_failed_since_midnight,json=httpsPostsFailedSinceMidnight,proto3" json:"https_posts_failed_since_midnight,omitempty"`
...
func (m *AuditLog_DestinationStatus) GetDetails() string {
	if m != nil {
		return m.Details
	}
	return ""
...
func (m *AuditLog_DestinationStatus) GetEventsSinceMidnight() int64 {
	if m != nil {
		return m.EventsSinceMidnight
	}
	return 0
}

func (m *AuditLog_DestinationStatus) GetEventsExcludedSinceMidnight() int64 {
	if m != nil {
		return m.EventsExcludedSinceMidnight
	}
	return 0
}

func (m *AuditLog_DestinationStatus) GetEventsUndeliverableSinceMidnight() int64 {
	if m != nil {
		return m.EventsUndeliverableSinceMidnight
	}
	return 0
}

func (m *AuditLog_DestinationStatus) GetBytesSucceededSinceMidnight() int64 {
	if m != nil {
		return m.BytesSucceededSinceMidnight
	}
	return 0
}

func (m *AuditLog_DestinationStatus) GetBytesFailedSinceMidnight() int64 {
	if m != nil {
		return m.BytesFailedSinceMidnight
	}
	return 0
}

func (m *AuditLog_DestinationStatus) GetHttpsPostsSucceededSinceMidnight() int64 {
	if m != nil {
		return m.HttpsPostsSucceededSinceMidnight
	}
	return 0
}

func (m *AuditLog_DestinationStatus) GetHttpsPostsFailedSinceMidnight() int64 {
	if m != nil {
		return m.HttpsPostsFailedSinceMidnight
	}
	return 0
}
...
type AuditLog_Destination struct {
	...
	// This is a read-only value.
	Statusses            []*AuditLog_DestinationStatus `protobuf:"bytes,100,rep,name=Statusses,proto3" json:"Statusses,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}
...
func (m *AuditLog_Destination) GetStatusses() []*AuditLog_DestinationStatus {
	if m != nil {
		return m.Statusses
	}
	return nil
...
var fileDescriptor_5594839dd8e38a1b = []byte{
	...
	,
}
...
func (m *AuditLog_DestinationStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HttpsPostsFailedSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.HttpsPostsFailedSinceMidnight))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf8
	}
	if m.HttpsPostsSucceededSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.HttpsPostsSucceededSinceMidnight))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf0
	}
	if m.BytesFailedSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.BytesFailedSinceMidnight))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa8
	}
	if m.BytesSucceededSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.BytesSucceededSinceMidnight))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
	}
	if m.EventsUndeliverableSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.EventsUndeliverableSinceMidnight))
		i--
		dAtA[i] = 0x60
	}
	if m.EventsExcludedSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.EventsExcludedSinceMidnight))
		i--
		dAtA[i] = 0x58
	}
	if m.EventsSinceMidnight != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.EventsSinceMidnight))
		i--
		dAtA[i] = 0x50
	}
	if len(m.Details) > 0 {
...
func (m *AuditLog_Destination) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Statusses) > 0 {
		for iNdEx := len(m.Statusses) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Statusses[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *AuditLog_DestinationStatus) Size() (n int) {
	...
	if m.EventsSinceMidnight != 0 {
		n += 1 + sovAudit(uint64(m.EventsSinceMidnight))
	}
	if m.EventsExcludedSinceMidnight != 0 {
		n += 1 + sovAudit(uint64(m.EventsExcludedSinceMidnight))
	}
	if m.EventsUndeliverableSinceMidnight != 0 {
		n += 1 + sovAudit(uint64(m.EventsUndeliverableSinceMidnight))
	}
	if m.BytesSucceededSinceMidnight != 0 {
		n += 2 + sovAudit(uint64(m.BytesSucceededSinceMidnight))
	}
	if m.BytesFailedSinceMidnight != 0 {
		n += 2 + sovAudit(uint64(m.BytesFailedSinceMidnight))
	}
	if m.HttpsPostsSucceededSinceMidnight != 0 {
		n += 2 + sovAudit(uint64(m.HttpsPostsSucceededSinceMidnight))
	}
	if m.HttpsPostsFailedSinceMidnight != 0 {
		n += 2 + sovAudit(uint64(m.HttpsPostsFailedSinceMidnight))
	}
	if m.UpdatedAt != nil {
		l = m.UpdatedAt.Size()
		n += 2 + l + sovAudit(uint64(l))
...
func (m *AuditLog_DestinationStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EventsSinceMidnight", wireType)
			}
			m.EventsSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EventsSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EventsExcludedSinceMidnight", wireType)
			}
			m.EventsExcludedSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EventsExcludedSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EventsUndeliverableSinceMidnight", wireType)
			}
			m.EventsUndeliverableSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EventsUndeliverableSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BytesSucceededSinceMidnight", wireType)
			}
			m.BytesSucceededSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BytesSucceededSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BytesFailedSinceMidnight", wireType)
			}
			m.BytesFailedSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BytesFailedSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 30:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpsPostsSucceededSinceMidnight", wireType)
			}
			m.HttpsPostsSucceededSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HttpsPostsSucceededSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 31:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpsPostsFailedSinceMidnight", wireType)
			}
			m.HttpsPostsFailedSinceMidnight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAudit
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HttpsPostsFailedSinceMidnight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *AuditLog_Destination) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 100:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Statusses", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Statusses = append(m.Statusses, &AuditLog_DestinationStatus{})
			if err := m.Statusses[len(m.Statusses)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
