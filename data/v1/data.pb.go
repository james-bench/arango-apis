...
type ImportDataInstructions struct {
	...
	ArangoImportXml      []string `protobuf:"bytes,5,rep,name=arango_import_xml,json=arangoImportXml,proto3" json:"arango_import_xml,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ImportDataInstructions) GetArangoImportXml() []string {
	if m != nil {
		return m.ArangoImportXml
	}
	return nil
}
...
var fileDescriptor_871986018790d2fd = []byte{
	...
	0xa1, 0x5d, 0xbb, 0xc9, 0xf6, 0x18, 0xb4, 0xa0, 0x4d, 0x45, 0x65, 0x46, 0x95, 0x73, 0x9c, 0xaf,
	0xcd, 0x8c, 0x6c, 0xbb, 0xc7, 0x58, 0x23, 0x56, 0x7b, 0xe0, 0xc4, 0x43, 0x2c, 0xd2, 0xdc, 0xe1,
	0xc0, 0x1e, 0x40, 0x48, 0x08, 0x10, 0x70, 0xe0, 0x0a, 0x1c, 0xd0, 0xa2, 0xfd, 0x03, 0x30, 0xcb,
	0x85, 0x13, 0x12, 0x88, 0x3b, 0x8a, 0x2f, 0x22, 0xab, 0x32, 0xeb, 0xd1, 0x95, 0x6d, 0xb1, 0xec,
	0xad, 0xf2, 0x7b, 0xc5, 0x97, 0x5f, 0x7c, 0xf1, 0xbd, 0x22, 0x0b, 0xc0, 0xa6, 0x9c, 0x36, 0xc3,
	...
	0xef, 0x07, 0x9c, 0x72, 0x27, 0xf0, 0x63, 0x89, 0xd5, 0xff, 0xf3, 0x2d, 0x80, 0x03, 0x16, 0xba,
	...
	0xf5, 0x59, 0x44, 0x65, 0x41, 0xe4, 0x12, 0x40, 0x18, 0x05, 0x9f, 0x31, 0x8b, 0x9b, 0x8e, 0x5d,
	0x9f, 0x43, 0x82, 0x45, 0x05, 0x69, 0xdb, 0xe4, 0x2d, 0x58, 0x8c, 0x58, 0xcf, 0x09, 0x7c, 0x81,
	0x9d, 0x47, 0x6c, 0x59, 0x02, 0xda, 0x36, 0xf9, 0x10, 0xc0, 0x8a, 0x18, 0xe5, 0xcc, 0x36, 0x29,
	...
	0x38, 0x5a, 0x73, 0x7f, 0xc0, 0x76, 0x14, 0x32, 0xcb, 0xc8, 0xc9, 0x21, 0x9f, 0xc0, 0x42, 0xcc,
	...
	0x40, 0xdb, 0x36, 0xd9, 0x83, 0x39, 0x2f, 0xb0, 0x99, 0x5b, 0xff, 0x0c, 0x97, 0xfb, 0x7a, 0x81,
	0xe5, 0xbe, 0x2d, 0xe8, 0x71, 0x31, 0xc9, 0x4a, 0xde, 0x86, 0xaa, 0x95, 0xc4, 0x3c, 0xf0, 0x4c,
	...
	0x27, 0x71, 0xfd, 0x1f, 0x35, 0xd4, 0xe7, 0x46, 0x91, 0xd7, 0x47, 0x0e, 0x43, 0x71, 0x92, 0xfb,
	0x30, 0x1b, 0x3b, 0x9f, 0xb3, 0xfa, 0x3f, 0x49, 0x09, 0xd7, 0xa6, 0x4b, 0x38, 0x72, 0x3e, 0x67,
	0xde, 0x39, 0x73, 0x66, 0x92, 0xaf, 0x7e, 0xae, 0x33, 0x0a, 0x24, 0x1f, 0xc0, 0x79, 0x1e, 0x70,
	0xea, 0x9a, 0x6a, 0x45, 0x0c, 0x33, 0x9d, 0x13, 0x51, 0x32, 0x89, 0x4a, 0x6d, 0xc6, 0x58, 0x43,
	0xb4, 0x94, 0x27, 0x22, 0xc5, 0x9e, 0xc0, 0x91, 0x0f, 0xe1, 0x82, 0x62, 0x48, 0x42, 0x37, 0xa0,
	0xb6, 0xe9, 0xf8, 0x66, 0x18, 0x05, 0xbd, 0x88, 0xc5, 0xb2, 0xd6, 0x2a, 0x1b, 0x1b, 0x92, 0xe0,
	0x53, 0xc4, 0xb7, 0xfd, 0x43, 0x85, 0x6d, 0xfc, 0x8e, 0x06, 0xe7, 0xc6, 0xa8, 0x27, 0x1c, 0x32,
	...
	0x11, 0x33, 0x23, 0x46, 0xe3, 0xc0, 0x57, 0xb5, 0x6a, 0x4d, 0x41, 0x0d, 0x04, 0x36, 0xfe, 0x5b,
	...
	0xba, 0xc4, 0x86, 0xe0, 0xfe, 0x55, 0xc9, 0xfc, 0xb1, 0xe0, 0x3d, 0x62, 0xbe, 0x70, 0xbf, 0x7b,
	0x93, 0xe5, 0xf2, 0xa0, 0x3e, 0x8b, 0x47, 0x68, 0x2c, 0xef, 0x93, 0xa0, 0xf1, 0x7b, 0x1a, 0xac,
	0x8e, 0xd4, 0x2f, 0xa7, 0x6e, 0x42, 0x1a, 0xd2, 0x92, 0xd0, 0x4e, 0x03, 0x7a, 0xa9, 0x58, 0x48,
	0xfb, 0x54, 0x72, 0xec, 0x72, 0xd1, 0x4e, 0x29, 0xbf, 0xe9, 0xb7, 0x25, 0x65, 0x09, 0x68, 0xdb,
	0xfa, 0xbf, 0x68, 0x50, 0x7e, 0xa4, 0xf2, 0xda, 0xb8, 0xfc, 0x83, 0xdd, 0x5d, 0x29, 0xd3, 0xdd,
	...
	,
}
...
func (m *ImportDataInstructions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ArangoImportXml) > 0 {
		for iNdEx := len(m.ArangoImportXml) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ArangoImportXml[iNdEx])
			copy(dAtA[i:], m.ArangoImportXml[iNdEx])
			i = encodeVarintData(dAtA, i, uint64(len(m.ArangoImportXml[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
...
func (m *ImportDataInstructions) Size() (n int) {
	...
	if len(m.ArangoImportXml) > 0 {
		for _, s := range m.ArangoImportXml {
			l = len(s)
			n += 1 + l + sovData(uint64(l))
		}
	}
...
func (m *ImportDataInstructions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ArangoImportXml", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ArangoImportXml = append(m.ArangoImportXml, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipData(dAtA[iNdEx:])
