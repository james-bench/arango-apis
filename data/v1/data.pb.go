...
type Deployment struct {
	...
	ShardedDeploymentRecommendations []*ShardedDeploymentSizeRecommendation `protobuf:"bytes,501,rep,name=sharded_deployment_recommendations,json=shardedDeploymentRecommendations,proto3" json:"sharded_deployment_recommendations,omitempty"`
...
func (m *Deployment) GetShardedDeploymentRecommendations() []*ShardedDeploymentSizeRecommendation {
	if m != nil {
		return m.ShardedDeploymentRecommendations
	}
	return nil
}
...
type ShardedDeploymentSizeRequest struct {
	...
	// Must be >= 0.0 and <= 1.0
	WorkingSetPercentage float32 `protobuf:"fixed32,3,opt,name=working_set_percentage,json=workingSetPercentage,proto3" json:"working_set_percentage,omitempty"`
	// Percentage of operations that are READ
	// Must be >= 0.0 and <= 1.0
	AccessReadPercentage float32 `protobuf:"fixed32,4,opt,name=access_read_percentage,json=accessReadPercentage,proto3" json:"access_read_percentage,omitempty"`
	// Percentage of operations that are CREATE
	// Must be >= 0.0 and <= 1.0
	AccessCreatePercentage float32 `protobuf:"fixed32,5,opt,name=access_create_percentage,json=accessCreatePercentage,proto3" json:"access_create_percentage,omitempty"`
	// Percentage of operations that are UPDATE
	// Must be >= 0.0 and <= 1.0
	AccessUpdatePercentage float32 `protobuf:"fixed32,6,opt,name=access_update_percentage,json=accessUpdatePercentage,proto3" json:"access_update_percentage,omitempty"`
	// Increase factor of the dataset_size in 1 year.
	GrowthRate float32 `protobuf:"fixed32,7,opt,name=growth_rate,json=growthRate,proto3" json:"growth_rate,omitempty"`
...
func (m *ShardedDeploymentSizeRequest) Reset()         { *m = ShardedDeploymentSizeRequest{} }
func (m *ShardedDeploymentSizeRequest) String() string { return proto.CompactTextString(m) }
func (*ShardedDeploymentSizeRequest) ProtoMessage()    {}
func (*ShardedDeploymentSizeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_871986018790d2fd, []int{17}
}
func (m *ShardedDeploymentSizeRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ShardedDeploymentSizeRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ShardedDeploymentSizeRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ShardedDeploymentSizeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ShardedDeploymentSizeRequest.Merge(m, src)
}
func (m *ShardedDeploymentSizeRequest) XXX_Size() int {
	return m.Size()
}
func (m *ShardedDeploymentSizeRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ShardedDeploymentSizeRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ShardedDeploymentSizeRequest proto.InternalMessageInfo

func (m *ShardedDeploymentSizeRequest) GetDatasetSize() int32 {
	if m != nil {
...
func (m *ShardedDeploymentSizeRequest) GetFileFormat() string {
	if m != nil {
		return m.FileFormat
	}
	return ""
...
func (m *ShardedDeploymentSizeRequest) GetWorkingSetPercentage() float32 {
	if m != nil {
...
func (m *ShardedDeploymentSizeRequest) GetAccessReadPercentage() float32 {
	if m != nil {
...
func (m *ShardedDeploymentSizeRequest) GetAccessCreatePercentage() float32 {
	if m != nil {
...
func (m *ShardedDeploymentSizeRequest) GetAccessUpdatePercentage() float32 {
	if m != nil {
...
func (m *ShardedDeploymentSizeRequest) GetGrowthRate() float32 {
	if m != nil {
		return m.GrowthRate
	}
	return 0
...
func (m *ShardedDeploymentSizeRequest) GetReplicationFactor() int32 {
	if m != nil {
...
func (m *ShardedDeploymentSizeRequest) GetUsecase() string {
	if m != nil {
		return m.Usecase
	}
	return ""
...
type ShardedDeploymentSizeRecommendation struct {
	// Request that resulted in this recommendation.
	Request *ShardedDeploymentSizeRequest `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
...
func (m *ShardedDeploymentSizeRecommendation) Reset()         { *m = ShardedDeploymentSizeRecommendation{} }
func (m *ShardedDeploymentSizeRecommendation) String() string { return proto.CompactTextString(m) }
func (*ShardedDeploymentSizeRecommendation) ProtoMessage()    {}
func (*ShardedDeploymentSizeRecommendation) Descriptor() ([]byte, []int) {
	return fileDescriptor_871986018790d2fd, []int{18}
}
func (m *ShardedDeploymentSizeRecommendation) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ShardedDeploymentSizeRecommendation) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ShardedDeploymentSizeRecommendation.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ShardedDeploymentSizeRecommendation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ShardedDeploymentSizeRecommendation.Merge(m, src)
}
func (m *ShardedDeploymentSizeRecommendation) XXX_Size() int {
	return m.Size()
}
func (m *ShardedDeploymentSizeRecommendation) XXX_DiscardUnknown() {
	xxx_messageInfo_ShardedDeploymentSizeRecommendation.DiscardUnknown(m)
}

var xxx_messageInfo_ShardedDeploymentSizeRecommendation proto.InternalMessageInfo

func (m *ShardedDeploymentSizeRecommendation) GetRequest() *ShardedDeploymentSizeRequest {
	if m != nil {
		return m.Request
	}
	return nil
...
func (m *ShardedDeploymentSizeRecommendation) GetCreatedAt() *types.Timestamp {
	if m != nil {
		return m.CreatedAt
	}
	return nil
...
func (m *ShardedDeploymentSizeRecommendation) GetNodeMemorySize() int32 {
	if m != nil {
		return m.NodeMemorySize
	}
	return 0
...
func (m *ShardedDeploymentSizeRecommendation) GetNodeDiskSize() int32 {
	if m != nil {
		return m.NodeDiskSize
	}
	return 0
...
func (m *ShardedDeploymentSizeRecommendation) GetNodeCount() int32 {
	if m != nil {
		return m.NodeCount
	}
	return 0
...
type DeploymentPrice_BackupPrice struct {
	...
	PricePerGb           float32  `protobuf:"fixed32,1,opt,name=price_per_gb,json=pricePerGb,proto3" json:"price_per_gb,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *DeploymentPrice_BackupPrice) GetPricePerGb() float32 {
	if m != nil {
		return m.PricePerGb
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*ShardedDeploymentSizeRequest)(nil), "arangodb.cloud.data.v1.ShardedDeploymentSizeRequest")
	proto.RegisterType((*ShardedDeploymentSizeRecommendation)(nil), "arangodb.cloud.data.v1.ShardedDeploymentSizeRecommendation")
...
var fileDescriptor_871986018790d2fd = []byte{
	...
	,
}
...
type DataServiceClient interface {
	...
	// Required permissions:
	// - none
	RecommendShardedDeploymentSize(ctx context.Context, in *ShardedDeploymentSizeRequest, opts ...grpc.CallOption) (*ShardedDeploymentSizeRecommendation, error)
...
func (c *dataServiceClient) RecommendShardedDeploymentSize(ctx context.Context, in *ShardedDeploymentSizeRequest, opts ...grpc.CallOption) (*ShardedDeploymentSizeRecommendation, error) {
	out := new(ShardedDeploymentSizeRecommendation)
	err := c.cc.Invoke(ctx, "/arangodb.cloud.data.v1.DataService/RecommendShardedDeploymentSize", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DataServiceServer interface {
	...
	// Required permissions:
	// - none
	RecommendShardedDeploymentSize(context.Context, *ShardedDeploymentSizeRequest) (*ShardedDeploymentSizeRecommendation, error)
	// Fetch instructions for connecting drivers to the deployment identified by the given id.
	// Required permissions:
	// - data.deployment.get on the deployment identified by the given ID
...
func (*UnimplementedDataServiceServer) RecommendShardedDeploymentSize(ctx context.Context, req *ShardedDeploymentSizeRequest) (*ShardedDeploymentSizeRecommendation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RecommendShardedDeploymentSize not implemented")
}
...
func _DataService_RecommendShardedDeploymentSize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShardedDeploymentSizeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataServiceServer).RecommendShardedDeploymentSize(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/arangodb.cloud.data.v1.DataService/RecommendShardedDeploymentSize",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataServiceServer).RecommendShardedDeploymentSize(ctx, req.(*ShardedDeploymentSizeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DataService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RecommendShardedDeploymentSize",
			Handler:    _DataService_RecommendShardedDeploymentSize_Handler,
		},
		{
...
func (m *Deployment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ShardedDeploymentRecommendations) > 0 {
		for iNdEx := len(m.ShardedDeploymentRecommendations) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ShardedDeploymentRecommendations[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ShardedDeploymentSizeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ShardedDeploymentSizeRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ShardedDeploymentSizeRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ShardedDeploymentSizeRecommendation) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ShardedDeploymentSizeRecommendation) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ShardedDeploymentSizeRecommendation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DeploymentPrice_BackupPrice) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PricePerGb != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.PricePerGb))))
		i--
		dAtA[i] = 0xd
	}
	return len(dAtA) - i, nil
...
func (m *Deployment) Size() (n int) {
	...
	if len(m.ShardedDeploymentRecommendations) > 0 {
		for _, e := range m.ShardedDeploymentRecommendations {
			l = e.Size()
			n += 2 + l + sovData(uint64(l))
		}
	}
...
func (m *ShardedDeploymentSizeRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ShardedDeploymentSizeRecommendation) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Deployment) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 501:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShardedDeploymentRecommendations", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ShardedDeploymentRecommendations = append(m.ShardedDeploymentRecommendations, &ShardedDeploymentSizeRecommendation{})
			if err := m.ShardedDeploymentRecommendations[len(m.ShardedDeploymentRecommendations)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ShardedDeploymentSizeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ShardedDeploymentSizeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ShardedDeploymentSizeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ShardedDeploymentSizeRecommendation) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ShardedDeploymentSizeRecommendation: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ShardedDeploymentSizeRecommendation: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Request == nil {
				m.Request = &ShardedDeploymentSizeRequest{}
			}
...
func (m *DeploymentPrice_BackupPrice) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field PricePerGb", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.PricePerGb = float32(math.Float32frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipData(dAtA[iNdEx:])
			if err != nil {
