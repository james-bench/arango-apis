...
type User struct {
	...
	EmailType            string   `protobuf:"bytes,14,opt,name=emailType,proto3" json:"emailType,omitempty"`
	GivenName            string   `protobuf:"bytes,15,opt,name=givenName,proto3" json:"givenName,omitempty"`
	FamilyName           string   `protobuf:"bytes,16,opt,name=familyName,proto3" json:"familyName,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *User) GetEmailType() string {
	if m != nil {
		return m.EmailType
	}
	return ""
...
var fileDescriptor_cc04e339d3d55e6b = []byte{
	...
	,
}
...
func (m *User) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EmailType) > 0 {
		i -= len(m.EmailType)
		copy(dAtA[i:], m.EmailType)
		i = encodeVarintScim(dAtA, i, uint64(len(m.EmailType)))
		i--
		dAtA[i] = 0x72
	}
	if len(m.Email) > 0 {
		i -= len(m.Email)
		copy(dAtA[i:], m.Email)
		i = encodeVarintScim(dAtA, i, uint64(len(m.Email)))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.UserName) > 0 {
...
func (m *User) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EmailType", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EmailType = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GivenName", wireType)
