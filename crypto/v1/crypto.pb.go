...
type CACertificateInstructions struct {
	...
	Install []*CACertificateInstructions_PlatformInstructions `protobuf:"bytes,1,rep,name=install,proto3" json:"install,omitempty"`
	// Per platform instructions for uninstall of the CA certificate
	Uninstall            []*CACertificateInstructions_PlatformInstructions `protobuf:"bytes,2,rep,name=uninstall,proto3" json:"uninstall,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                          `json:"-"`
	XXX_unrecognized     []byte                                            `json:"-"`
	XXX_sizecache        int32                                             `json:"-"`
}
...
func (m *CACertificateInstructions) GetInstall() []*CACertificateInstructions_PlatformInstructions {
	if m != nil {
		return m.Install
	}
	return nil
...
func (m *CACertificateInstructions) GetUninstall() []*CACertificateInstructions_PlatformInstructions {
	if m != nil {
		return m.Uninstall
	}
	return nil
...
func (m *CACertificateInstructions_PlatformInstructions) GetSteps() []string {
	if m != nil {
		return m.Steps
	}
	return nil
...
var fileDescriptor_527278fb02d03321 = []byte{
	...
	,
}
...
type CryptoServiceClient interface {
	...
	// Required permissions:
	// - crypto.cacertificate.get on the CA certificate identified by the given ID
	GetCACertificateInstructionsList(ctx context.Context, in *v1.IDOptions, opts ...grpc.CallOption) (*CACertificateInstructions, error)
...
func (c *cryptoServiceClient) GetCACertificateInstructionsList(ctx context.Context, in *v1.IDOptions, opts ...grpc.CallOption) (*CACertificateInstructions, error) {
	out := new(CACertificateInstructions)
	err := c.cc.Invoke(ctx, "/arangodb.cloud.crypto.v1.CryptoService/GetCACertificateInstructionsList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CryptoServiceServer interface {
	...
	// Required permissions:
	// - crypto.cacertificate.get on the CA certificate identified by the given ID
	GetCACertificateInstructionsList(context.Context, *v1.IDOptions) (*CACertificateInstructions, error)
	// Create a new CA certificate
	// Required permissions:
	// - crypto.cacertificate.create on the project that owns the CA certificate
...
func _CryptoService_GetCACertificateInstructionsList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.IDOptions)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CryptoServiceServer).GetCACertificateInstructionsList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/arangodb.cloud.crypto.v1.CryptoService/GetCACertificateInstructionsList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CryptoServiceServer).GetCACertificateInstructionsList(ctx, req.(*v1.IDOptions))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CryptoService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCACertificateInstructionsList",
			Handler:    _CryptoService_GetCACertificateInstructionsList_Handler,
		},
		{
...
func (m *CACertificateInstructions) Size() (n int) {
	...
	_ = l
	if len(m.Install) > 0 {
		for _, e := range m.Install {
			l = e.Size()
			n += 1 + l + sovCrypto(uint64(l))
		}
	}
	if len(m.Uninstall) > 0 {
		for _, e := range m.Uninstall {
			l = e.Size()
			n += 1 + l + sovCrypto(uint64(l))
		}
	}
...
func (m *CACertificateInstructions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Install = append(m.Install, &CACertificateInstructions_PlatformInstructions{})
			if err := m.Install[len(m.Install)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			m.Uninstall = append(m.Uninstall, &CACertificateInstructions_PlatformInstructions{})
			if err := m.Uninstall[len(m.Uninstall)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
